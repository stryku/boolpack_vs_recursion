...
def print_params(compiler, proposal_version, case, test_type_namespace, disjunction_namespace, result):
	print(compiler + ', \t' + proposal_version + ', \t' + case + ', \t' + test_type_namespace + ', \t' + disjunction_namespace + ', \t' + result)
...
run_tests(TIMES_TO_RUN, CLANG, 'bools', 'best_case',    'std',  'light')
run_tests(TIMES_TO_RUN, CLANG, 'bools', 'worse_case', 'prop', 'light')
run_tests(TIMES_TO_RUN, CLANG, 'bools', 'worse_case', 'std',  'light')
...
run_tests(TIMES_TO_RUN, CLANG, 'bools', 'best_case',    'std',  'heavy')
run_tests(TIMES_TO_RUN, CLANG, 'bools', 'worse_case', 'prop', 'heavy')
run_tests(TIMES_TO_RUN, CLANG, 'bools', 'worse_case', 'std',  'heavy')
...
run_tests(TIMES_TO_RUN, GXX, 'bools', 'best_case',    'std',  'light')
run_tests(TIMES_TO_RUN, GXX, 'bools', 'worse_case', 'prop', 'light')
run_tests(TIMES_TO_RUN, GXX, 'bools', 'worse_case', 'std',  'light')
...
run_tests(TIMES_TO_RUN, GXX, 'bools', 'best_case',    'std',  'heavy')
run_tests(TIMES_TO_RUN, GXX, 'bools', 'worse_case', 'prop', 'heavy')
run_tests(TIMES_TO_RUN, GXX, 'bools', 'worse_case', 'std',  'heavy')
